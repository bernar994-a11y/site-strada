...
vitrineSaveBtn?.addEventListener('click', async () => {
    ...
    try {
        if (!S_URL || !S_KEY) throw new Error("Chaves do Supabase n�o encontradas");
        ...
        vitrineStatus.innerText = '? Imagem atualizada com sucesso! Recarregue a p�gina inicial para ver.';
        vitrineBase64 = '';
        setTimeout(() => {
